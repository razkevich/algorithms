...
- **All-problems reference** — [`system-design-problems.html`](visualizations/system-design-problems.html) — 11-tab interview reference: core idea + animated architecture + 2-4 deep dives per problem (URL Shortener, News Feed, Messenger, Webhook, Cache, Ride-Share, Payment, Rate Limiter, Job Scheduler, Video Stream, Typeahead). Each deep dive has a pattern-transfer callout
